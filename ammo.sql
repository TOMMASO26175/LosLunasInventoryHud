...
INSERT INTO essentialmode.items (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES ('ammo_pistol', 'Munizioni Pistola', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES ('ammo_rifle', 'Munizioni Assalto', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES ('ammo_shotgun', 'Munizioni Shotgun', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES ('ammo_smg', 'Munizioni Mitra', 1, 0, 1);
INSERT INTO essentialmode.items (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES ('ammo_snp', 'Munizioni Cecchino', 1, 0, 1);
